...
"""
rescale_activations!(::Union{Binary,Spin,Potts,PottsGumbel}, ::AbstractArray) = false
rescale_activations!(::nsReLU, ::AbstractArray) = false # γ is fixed at 1; there is no scale to move
