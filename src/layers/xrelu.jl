...
cgfs(layer::xReLU, inputs::AbstractArray = Falses(size(layer))) = cgfs(dReLU(layer), inputs)
sample_from_inputs(layer::xReLU, inputs::AbstractArray = Falses(size(layer))) = sample_from_inputs(dReLU(layer), inputs)
mode_from_inputs(layer::xReLU, inputs::AbstractArray = Falses(size(layer))) = mode_from_inputs(dReLU(layer), inputs)
mean_from_inputs(layer::xReLU, inputs::AbstractArray = Falses(size(layer))) = mean_from_inputs(dReLU(layer), inputs)
var_from_inputs(layer::xReLU, inputs::AbstractArray = Falses(size(layer))) = var_from_inputs(dReLU(layer), inputs)
meanvar_from_inputs(layer::xReLU, inputs::AbstractArray = Falses(size(layer))) = meanvar_from_inputs(dReLU(layer), inputs)
mean_abs_from_inputs(layer::xReLU, inputs::AbstractArray = Falses(size(layer))) = mean_abs_from_inputs(dReLU(layer), inputs)
