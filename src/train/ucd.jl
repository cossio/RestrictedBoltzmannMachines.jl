...
function _maximal_coupling_step(
    ...
    (isnothing(v2) || isnothing(vc1)) && throw(ArgumentError("maximal coupling residual rejection did not accept within max_tries = $max_tries; increase max_tries in unbiased_sample or ucd!"))
