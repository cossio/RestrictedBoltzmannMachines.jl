function _cd_hyper_random(rbm_init::RBM, train_data::Data; tests_data::Data=train_data, decay,
                            λws = (@. 10^(-4:0.1:0)), λgs = (@. 10^(-5:0.1:0)), λhs = (@. 10^(-4:0.1:0)),
                            w0s = 0:0.01:2, β0s=0:1e-6:1, η0s = 0:1e-6:0.05, cd_steps = 1:10,
