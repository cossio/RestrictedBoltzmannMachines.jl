...
function ∂regularize_add_visible_offset!(∂::∂RBM, visible_regularization::AbstractArray, offset_h::AbstractArray, ::Union{Binary,Spin,Potts,PottsGumbel,Gaussian,ReLU,xReLU,pReLU})
